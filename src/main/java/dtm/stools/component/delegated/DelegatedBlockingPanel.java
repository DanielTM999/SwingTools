...
public abstract class DelegatedBlockingPanel<T extends AbstractViewController<BlockingPanel>> extends BlockingPanel implements DelegatedIWindowComponent{

    protected Class<T> controllerClass;
    protected T controller;

    public DelegatedBlockingPanel(){
        delegateInit();
    }

    public DelegatedBlockingPanel(LayoutManager layout){
        super(layout);
        delegateInit();
    }
